package com.tiendita.tienditapromosconsumer.config;
...
@EnableJpaRepositories(
    basePackages = "com.tiendita.tienditapromosconsumer.repository",
...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        ...
        config.setPoolName("PromosConsumerHikariPool");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.tiendita.tienditapromosconsumer.models");
